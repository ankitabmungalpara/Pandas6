...
# The function removes duplicate emails while keeping the record with the smallest ID. 
# It first identifies the minimum ID for each email and removes rows with higher IDs. 
# Alternatively, it sorts by ID and drops duplicates, keeping the first occurrence.
